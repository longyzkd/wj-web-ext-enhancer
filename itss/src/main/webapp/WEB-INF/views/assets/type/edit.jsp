	...
	<script type="text/javascript">
		Ext.onReady(function(){
            ...
            var txtName = new Ext.form.field.Text({
                   name: 'name',
                   fieldLabel: '资产类型名称'+'<font color=red>*</font>',
                   maxLength: 20,
                   allowBlank: false,
                 //  vtype:'checkunique',
                   beanClazz:'AssetsType',
                   property:'name',
                   action:action
               });
           ...
           <%=com.kingen.util.JsonHelperJS.FormExtJsModel("com.kingen.bean.SkillCat", "Model", "","")%>
            ...
            function handleProcess() {
                ...
                if (action == 'insert' || action == 'update') {
                    var action_url= '<%=basePath%>assets/type/save?pid='+pid;
                    if(action == 'update'){
                    	action_url= '<%=basePath%>assets/type/update?id='+id;
                    }
