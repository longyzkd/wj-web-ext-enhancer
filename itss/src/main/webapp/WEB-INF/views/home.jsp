...
<head>
    ...
    Ext.onReady(function () {    
        ...
        var frmSouth = new Ext.Component({
            ...
            region: 'south',
            border: 1,
            html: "<table border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td style='height:26px; color:white; text-align: center;'>©欢迎使用ITSS 运维交付平台 </td></tr></table>"
        });
            ...
            // create instance immediately
                Ext.create('Ext.Component', {
                    ...
                    html: '<table width="100%" style="margin-left:20px; color:white;" cellspacing="0" cellpadding="0">' +
                            '<tr style="height:20px;"><td width="400px" style="font-size:28px;" rowspan="2"><strong>ITSS 运维交付平台</strong></td></tr>' +
                            '<tr>' +
        ...
        function UpdatePWD() {
            ...
            if (!form) {
                ...
                var txtNewPwdAg = new Ext.form.field.Text({
                    ...
                    fieldLabel: '再次输入'+'<font color=red>*</font>',
                    regex: /^[A-Za-z0-9_]+$/,
                    regexText: '请输入有效的密码，含数字，	字母，下划线',
                    allowBlank: false,
                    labelWidth: 60,
                        ...
                        handler: function () {
                            if (form.isValid()) {
                                form.submit({
                                    ...
                                    url: '<%=path%>/user/updateCurrentPwd',
