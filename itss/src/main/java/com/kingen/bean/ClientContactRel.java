...
/**
 * TClientContactRel entity.
 * 
 * @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_client_contact_rel")
public class ClientContactRel implements java.io.Serializable {
	...
	@AttributeOverrides( {
			...
			@AttributeOverride(name = "clientContactId", column = @Column(name = "client_contact_id", nullable = false, length = 32)) })
