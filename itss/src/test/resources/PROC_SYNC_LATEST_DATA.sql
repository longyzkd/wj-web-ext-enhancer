...
as
	 ...
	 --mysql
     exec PROC_SYNC_ONE_LATEST_DATA 'kingen_gzjzz_shchuan', ''  ,'mysql';
	 exec PROC_SYNC_ONE_LATEST_DATA 'kingen_ylh_shchuan', ''  ,'mysql';
	 exec PROC_SYNC_ONE_LATEST_DATA 'kingen_ysh_shchuan', ''  ,'mysql';
